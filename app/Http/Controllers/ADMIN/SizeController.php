...
class SizeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($search))
            $lstSize = size::where('name', 'LIKE', "%$search%")->paginate(5);
        else
            $lstSize = size::paginate(5);
        $lstSize->appends($request->all());

        return view('Admin.size.index', ['lstSize' => $lstSize]);
    }
    ...
    public function create()
    {
        ...
        return view('Admin.size.create', ['lstSize' => $lstSize]);
    }
    ...
    public function deleted()
    {
        ...
        return view('Admin.size.delete', ['lstSize' => $lstSize]);
    }
    public function restore($id)
    {
        ...
        $size->save();
        $size->restore();
        return Redirect::route('admin.size.deleted')->with('restored', 'ok');
    }
}
