...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($search))
            $lstProduct = product::where('name', 'LIKE', "%$search%")->orWhere('id', 'LIKE', "%$search%")->paginate();
        else
        ...
        return view('product.index', ['lstProduct' => $lstProduct]);
    }
    ...
    public function create()
    {
        ...
        return view('product.create', ['lstCategory' => $lstCategory]);
    }
    ...
    public function edit(product $product)
    {
        ...
        return view('product.edit', ['product' => $product, 'lstCategory' => $lstCategory]);
    }
    ...
    public function deleted()
    {
        ...
        return view('product.delete', ['lstProduct' => $lstProduct]);
    }
    public function restore($id)
    {
        ...
        $product->save();
        $product->restore();
        return Redirect::route('product.deleted')->with('restored', 'ok');
    }
}
