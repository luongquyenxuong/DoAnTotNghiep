...
class ToppingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($search))
            $lstTopping = topping::where('name', 'LIKE', "%$search%")->orWhere('id', 'LIKE', "%$search%")->paginate();
        else
            $lstTopping = topping::paginate(5);
        $lstTopping->appends($request->all());

        return view('topping.index', ['lstTopping' => $lstTopping]);
    }
    ...
    public function create()
    {
        ...
        return view('topping.create', ['lstTopping' => $lstTopping]);
    }
    ...
    {
        return view('topping.show', ['topping' => $topping]);
    }
    ...
    {
        return view('topping.edit',["topping"=> $topping]);
    }
    ...
    public function deleted()
    {
        ...
        return view('topping.delete', ['lstTopping' => $lstTopping]);
    }
    public function restore($id)
    {
        ...
        $topping->save();
        $topping->restore();
        return Redirect::route('topping.deleted')->with('restored', 'ok');
    }
}
