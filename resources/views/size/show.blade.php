    ...
    <div class="card">
        <div class="card-body">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-block-title d-inline-block">Detail size</h2>
                    </div>
                </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <form class="tm-edit-product-form">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder disabled value="{{ $size->name }}"
                                    class="form-control ">
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    ...
                                    @else
                                        <input id="" name="" type="text" value="{{ $size->created_at->format('d-m-Y') }}" disabled
                                            class="form-control validate hasDatepicker" data-large-mode="true">
                                    @endif
